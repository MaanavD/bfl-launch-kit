...
1. **Written tutorial** — Build something with the [FLUX API](https://docs.bfl.ml/). Zero to working result in under 15 min. Code must work, writing must be publish-ready.
...
- **Product**: FLUX.2 by Black Forest Labs (the team behind Stable Diffusion). API docs at https://docs.bfl.ml/. API keys from https://dashboard.bfl.ai.
